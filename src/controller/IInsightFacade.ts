...
export const MCOMPARATOR = ['LT', 'GT', 'EQ'];
export const SCOMPARISON = 'IS';
export const NEGATION = 'NOT';
export const MKEY = ['courses_avg', 'courses_pass', 'courses_fail', 'courses_audit', 'courses_year', 'rooms_lat', 'rooms_lon', 'rooms_seats'];
export const SKEY = ['courses_dept', 'courses_id', 'courses_instructor', 'courses_title', 'courses_uuid',
    'rooms_fullname', 'rooms_shortname', 'rooms_number', 'rooms_name', 'rooms_address',
    'rooms_type', 'rooms_furniture', 'rooms_href'];
export const ROOM_MKEY = ['rooms_lat', 'rooms_lon', 'rooms_seats'];
export const ROOM_SKEY = ['rooms_fullname', 'rooms_shortname', 'rooms_number', 'rooms_name', 'rooms_address', 'rooms_type', 'rooms_furniture', 'rooms_href'];
